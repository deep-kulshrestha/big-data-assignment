...
$mail->setFrom('info@schnellabs.com', 'Schnell Labs Notification'); // Replace with your sender email
    ...
    $emailSubject = "Drive Your Digital Transformation with Odoo Tailored Just for You!";
    $emailMessage = "
   <!DOCTYPE html>
<html lang='en'>
<head>
  ...
  <style type='text/css'>
    ...
    .hero img {
      width: 100%;
      max-width: 100px; /* Resize Odoo logo */
      height: auto;
    }
    .content {
      padding: 20px;
    ...
    <tr>
      <td>
        ...
        <table class='hero' width='100%'>
          <tr>
            <td>
                <h1>Now Give Your Business a Better Shape at Amazing Prices with Odoo Tailored Just for You!</h1>
            </td>
          </tr>
        </table>
        ...
        <table class='content' width='100%'>
          <tr>
            <td>
              ...
              <p>We understand the challenges and complexities businesses face in today’s fast-paced digital landscape, which is why we’re thrilled to introduce our <strong>Odoo implementation services at Schnell Labs</strong> — a modern, scalable, and comprehensive ERP solution designed to streamline your operations.</p>
              <p>At Schnell Labs, we specialize in helping businesses thrive by tailoring Odoo to meet your specific needs, whether you operate in manufacturing, retail, distribution, healthcare, education, or the public sector. Our goal is to allow you to focus on your core activities while we handle the intricacies of ERP system configuration and implementation.</p>
            </td>
          </tr>
        </table>
        ...
        <table class='list-items' width='100%'>
          <tr>
            <td>
              <ul>
                <li><span>Business Consulting:</span> We help identify key opportunities and align Odoo with your business goals.</li>
                <li><span>Odoo Implementation & Configuration:</span> Quick and seamless setup tailored to your operations.</li>
        ...
        <table class='cta' width='100%'>
          <tr>
            <td>
              <a href='https://www.schnellabs.com/contact'>Ready to elevate your business operations with Odoo?</a>
            </td>
          </tr>
        </table>
